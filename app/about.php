...
<body>
    ...
    <div class="sticky-nav js-sticky-header">
      <div class="container position-relative">
        <div class="site-navigation text-center">
          <a href="index.php" class="logo menu-absolute m-0">MentorBridge<span class="text-primary"></span></a>
  ...
  <div class="untree_co-hero overlay" style="background-image: url('images/teaching_and_learning.png');">
    <div class="container">
      ...
      <div class="row justify-content-between">
        <div class="col-lg-4 mb-5 mb-lg-0">
          ...
          <div class="section-title mb-3" data-aos="fade-up" data-aos-delay="0">
            <h2 class="line-bottom mb-4">Become a Mentor</h2>
          </div>

          <p data-aos="fade-up" data-aos-delay="100">You can inspire others or be inspired by them—join us and grow together</p>

          <ul class="ul-check list-unstyled mb-5 primary" data-aos="fade-up" data-aos-delay="200">
        <li>Open the gateway to success with the power of education.</li>
        <li>Mentors illuminate the journey, sparking brilliance in every learner.</li>
        <li>In the symphony of growth, mentors compose the harmony that drives us forward.</li>
        </ul>
        ...
        <div class="col-lg-6" data-aos="fade-up" data-aos-delay="0">
          <figure class="img-wrap-2">
            <img src="images/ashesi_student_class.jpeg" alt="Image" class="img-fluid">
    ...
    <div class="container">
      <div class="row justify-content-center mb-5">
        <div class="col-lg-7 text-center" data-aos="fade-up" data-aos-delay="0">
          <h2 class="line-bottom text-center mb-4">Our Support Team</h2>
          <p>The real benefit of mentorship in the learning process goes beyond simply gaining knowledge; it is about gaining the insight to approach personal growth with purpose and clear vision.</p>
        </div>
      </div>
      <div class="row">
        <div class="col-12 col-sm-6 col-md-6 mb-4 mb-lg-0 col-lg-4" data-aos="fade-up" data-aos-delay="0">
          <div class="staff text-center">
            <div class="mb-4"><img src="images/steve.png" alt="Image" class="img-fluid"></div>
            <div class="staff-body">
              <h3 class="staff-name">Steve Nsabimana</h3>
              <span class="d-block position mb-4">The owner of MentorBridge</span>
              <p class="mb-4">Inspiring dreams, building connections: Uniting aspirations through mentorship, one step at a time.</p>
              <div class="social">
  ...
  <div class="row">
    <div class="col-lg-3 mr-auto">
      <div class="widget">
        ...
        <p>Everyone needs guidance at some point. Learning can be challenging and exhausting, but MentorBridge is here to transform it into a shared journey of growth and support.</p>
    ...
    <div class="col-lg-3">
      <div class="widget">
        ...
        <ul class="list-unstyled links mb-4">
          <li><a href="tel://233549675706">+233 549 675 706</a></li>
