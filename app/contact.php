        ...
        <div class="col-lg-4 mb-5 order-2 mb-lg-0" data-aos="fade-up" data-aos-delay="100">
          <div class="contact-info">
            ...
            <div class="email mt-4">
              ...
              <p>steve.nsabimana@ashesi.edu.gh</p>
            </div>
      ...
      <div class="row">
        <div class="col-lg-3 mr-auto">
          <div class="widget">
            ...
            <p>We all need coaches. Learning is a tough and tiring job. MentorBridge is here to make the journey of learning a collective one</p>
          </div>
          <div class="widget">
            <h3>Connect</h3>
        ...
        <div class="col-lg-3">
          <div class="widget">
            ...
            <ul class="list-unstyled links mb-4">
              <li><a href="tel://233599346549">+233 549 976 549</a></li>
              <li><a href="mailto:info@mydomain.com">stevensabimana.ashesi.edu.gh</a></li>
            </ul>
          </div>
        </div>
