  ...
  <div class="site-footer">
    ...
    <script>
      function isValidAge() 
      {
          ...
          const label = document.getElementById("dobnotification");
          ...
          if (dobInput) 
          {
              ...
              if (age >= 15) 
              {
                  label.innerHTML = "<p></p>"; // Clear the error message
                  return true;
              } 
              else 
              {
                  label.innerHTML = "<p>You must be at least 15 years old!</p>";
          ...
          {
              label.innerHTML = "<p>Please enter your date of birth!</p>";
              label.style.color = "red";
              return false;
          }
      }
      ...
      registerForm.addEventListener("submit", function(event)
      {
        ...
        if (isStrongPassword() && isValidEmail() && checkSimilarity() && isValidAge())
        {

        const formData = new FormData(registerForm);
        console.log('Form submitted with:', Object.fromEntries(formData));
        fetch("action/register_action.php", {
          method: 'POST',
          body: formData,
        })
        .then(response => {
